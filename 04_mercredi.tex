...
\gscore{an_clamavi}
\translation{J'ai crié, et il m'a exaucé.}
...
\translation{Toi qui habites dans les cieux, aie pitié de nous.}
...
\translation{Heureux tous ceux qui craignent le Seigneur.}
...
\translation{Tout ce qu'il veut, le Seigneur le fait.}
\psalm{134}{3}

\smalltitle{Psaume 135}
\gscore{an_quoniam_in_aeternum}
\translation{Car éternel est son amour.}
\psalm{135}{3}

\smalltitle{Psaume 136}
\gscore{an_hymnum_cantate}
\translation{Chantez-nous un chant de Sion.}
\psalm{136}{8}

\smalltitle{Psaume 137}
\gscore{an_in_conspectu_angelorum}
\translation{Mon dieu, je te chanterai des psaumes en présence des anges.}
\psalm{137}{5}
...
\translation{Dieu a déployé la force de son bras: il disperse les superbes, il élève les humbles.}
\incipit{magn}{7c}
\psalm{magn}{7}
